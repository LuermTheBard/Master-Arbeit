...
calc_centroid_malte_code("NGC4593_optical_calibrated", "HBeta", lines=["OI8446"], include_mass=True, create_tex_file=True, top_percent=0.7)
calc_centroid_malte_code("NGC4593_optical_calibrated", "UVW2", lines=['HAlpha', 'HBeta', 'HGamma', 'HDelta', 'LyAlpha','HeI5875', 'HeII4685', 'OI8446', 'LyAlpha_not_optical_calibrated'], include_mass=True, create_tex_file=True, top_percent=0.7)
